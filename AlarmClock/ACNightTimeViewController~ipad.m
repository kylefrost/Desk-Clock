//
//  ACNightTimeViewController~ipad.m
//  AlarmClock
//
...
#import "ACNightTimeViewController~ipad.h"

@interface ACNightTimeViewController_ipad ()

@end

@implementation ACNightTimeViewController_ipad
