//
//  ACAddEditAlarmViewController.m
//  AlarmClock
//
...
@interface ACAddEditAlarmViewController ()

@end

@implementation ACAddEditAlarmViewController
...
- (void)viewDidLoad
{
    ...
    if (self.editMode) {
        ...
        ACAlarmObject * oldAlarmObject = [alarmList objectAtIndex:self.indexOfAlarmToEdit];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section == 0) {
        ...
        if(indexPath.row == 0) {
            ...
            ACAlarmLabelEditViewController *labelEditController = [mystoryboard instantiateViewControllerWithIdentifier:@"LabelEditView"];
...
-(IBAction)saveAlarm:(id)sender {
    ...
    if(self.editMode) { // Already Exists
        ...
        newAlarmObject = [[ACAlarmObject alloc]init];
